...
public static class CookedCharacterPackageLoader
{
    ...
    private static bool SupportedCapability(string id)=>id=="slop.internal.fightguy.cyclone-kick.v1"||id=="slop.internal.fightguy.dragon-beam.v1"||id=="slop.internal.fightguy.ki-shot.v1"||id=="slop.internal.fightguy.rising-dragon.v1"||id=="slop.internal.kistu.dash-slash.v1"||id=="slop.internal.kistu.rising-slash.v1"||id=="slop.internal.kistu.blade-flurry.v1"||id=="slop.internal.bonk.targeted-jump-slam.v1"||id=="slop.internal.manki.round-bomb.v1"||id=="slop.internal.manki.grapple.v1"||id=="slop.internal.manki.bazooka.v1"||id=="slop.internal.manki.overclock.v1";
    ...
    private static class RuntimeParser
    {
        ...
        private static CookedSlotDefinition ParseSlot(JsonElement e){var q=OOptional(e,"aimMovement","aimAnimationId","ordinal","id","isAir","name","description","iconId","behavior","aimMode","aimMovement","aimAnimationId","cooldownTicks","isRecoveryMove","preserveMomentumOnStart","chargePool","timeline");var pool=q["chargePool"].ValueKind==JsonValueKind.Null?null:ParseChargePool(q["chargePool"]);var t=O(q["timeline"],"stages");return new CookedSlotDefinition(I(q,"ordinal"),S(q,"id"),Bo(q,"isAir"),S(q,"name"),S(q,"description"),S(q,"iconId"),(AuthoringAbilityBehavior)B(q,"behavior"),(AuthoringAimMode)B(q,"aimMode"),U(q,"cooldownTicks"),Bo(q,"isRecoveryMove"),Bo(q,"preserveMomentumOnStart"),new CookedTimeline(A(t,"stages").EnumerateArray().Select(ParseStage).ToList()),pool,(AuthoringAimMovementMode)BOrDefault(q,"aimMovement",0),q.TryGetValue("aimAnimationId",out var aa)&&aa.ValueKind==JsonValueKind.String?aa.GetString():null);}
        ...
        private static CookedCapabilityParameters ParseParameters(string id, JsonElement e)
        {
            return id switch
            {
                ...
                "slop.internal.kistu.dash-slash.v1" => KistuDashSlash(O(e, "dashDistance", "dashDurationTicks", "maxAimTicks")),
                "slop.internal.kistu.rising-slash.v1" => KistuRisingSlash(O(e, "riseSpeed", "riseTicks", "homingRange", "homingSpeed")),
                "slop.internal.kistu.blade-flurry.v1" => KistuBladeFlurry(O(e, "forwardSpeed", "moveTicks")),
                ...
                "slop.internal.manki.round-bomb.v1" => MankiRoundBomb(O(e, "throwTriggerTick", "maxRange", "launchAngle", "gravity", "hitboxRadius", "damage", "stunTicks", "maxFlightTicks", "kbAngle", "explosionDamage", "explosionRadius", "explosionKbBase", "explosionKbGrowth", "explosionStunTicks", "explosionDurationTicks", "explosionKbAngle")),
                "slop.internal.manki.grapple.v1" => MankiGrapple(O(e, "fireTriggerTick", "tetherSpeed", "hitboxRadius", "maxFlightTicks", "maxRange", "reelSpeed", "arrivalThreshold", "damage", "stunTicks", "kbAngle", "castDuration")),
                "slop.internal.manki.bazooka.v1" => MankiBazooka(O(e, "fireTriggerTick", "projectileSpeed", "hitboxRadius", "damage", "gravity", "maxFlightTicks", "stunTicks", "explosionRadius", "kbAngle", "explosionKbBase", "explosionKbGrowth", "explosionStunTicks", "explosionDurationTicks", "explosionKbAngle", "castDuration", "recoveryDuration")),
                "slop.internal.manki.overclock.v1" => MankiOverclock(O(e, "durationTicks")),
        ...
        private static CookedCapabilityParameters KistuDashSlash(Dictionary<string, JsonElement> q) => new CookedKistuDashSlashCapabilityParameters(F(q, "dashDistance"), U(q, "dashDurationTicks"), U(q, "maxAimTicks"));
        private static CookedCapabilityParameters KistuRisingSlash(Dictionary<string, JsonElement> q) => new CookedKistuRisingSlashCapabilityParameters(F(q, "riseSpeed"), U(q, "riseTicks"), F(q, "homingRange"), F(q, "homingSpeed"));
        private static CookedCapabilityParameters KistuBladeFlurry(Dictionary<string, JsonElement> q) => new CookedKistuBladeFlurryCapabilityParameters(F(q, "forwardSpeed"), U(q, "moveTicks"));
        ...
        private static CookedCapabilityParameters MankiRoundBomb(Dictionary<string, JsonElement> q) => new CookedMankiRoundBombCapabilityParameters(U(q, "throwTriggerTick"), F(q, "maxRange"), F(q, "launchAngle"), F(q, "gravity"), F(q, "hitboxRadius"), F(q, "damage"), U(q, "stunTicks"), U(q, "maxFlightTicks"), F(q, "kbAngle"), F(q, "explosionDamage"), F(q, "explosionRadius"), F(q, "explosionKbBase"), F(q, "explosionKbGrowth"), U(q, "explosionStunTicks"), U(q, "explosionDurationTicks"), F(q, "explosionKbAngle"));
        private static CookedCapabilityParameters MankiGrapple(Dictionary<string, JsonElement> q) => new CookedMankiGrappleCapabilityParameters(U(q, "fireTriggerTick"), F(q, "tetherSpeed"), F(q, "hitboxRadius"), U(q, "maxFlightTicks"), F(q, "maxRange"), F(q, "reelSpeed"), F(q, "arrivalThreshold"), F(q, "damage"), U(q, "stunTicks"), F(q, "kbAngle"), U(q, "castDuration"));
        private static CookedCapabilityParameters MankiBazooka(Dictionary<string, JsonElement> q) => new CookedMankiBazookaCapabilityParameters(U(q, "fireTriggerTick"), F(q, "projectileSpeed"), F(q, "hitboxRadius"), F(q, "damage"), F(q, "gravity"), U(q, "maxFlightTicks"), U(q, "stunTicks"), F(q, "explosionRadius"), F(q, "kbAngle"), F(q, "explosionKbBase"), F(q, "explosionKbGrowth"), U(q, "explosionStunTicks"), U(q, "explosionDurationTicks"), F(q, "explosionKbAngle"), U(q, "castDuration"), U(q, "recoveryDuration"));
        private static CookedCapabilityParameters MankiOverclock(Dictionary<string, JsonElement> q) => new CookedMankiOverclockCapabilityParameters(U(q, "durationTicks"));
        private static Dictionary<string,JsonElement> O(JsonElement e,params string[] f){if(e.ValueKind!=JsonValueKind.Object)throw new InvalidDataException("Object required.");var set=new HashSet<string>(f,StringComparer.Ordinal);var d=new Dictionary<string,JsonElement>();foreach(var p in e.EnumerateObject())if(!set.Contains(p.Name)||!d.TryAdd(p.Name,p.Value))throw new InvalidDataException("Unknown or duplicate field.");foreach(var x in f)if(!d.ContainsKey(x))throw new InvalidDataException("Missing field.");return d;}
        private static Dictionary<string,JsonElement> OOptional(JsonElement e,string optional,string optional2,params string[] f){if(e.ValueKind!=JsonValueKind.Object)throw new InvalidDataException("Object required.");var set=new HashSet<string>(f,StringComparer.Ordinal);var d=new Dictionary<string,JsonElement>();foreach(var p in e.EnumerateObject())if(!set.Contains(p.Name)||!d.TryAdd(p.Name,p.Value))throw new InvalidDataException("Unknown or duplicate field.");foreach(var x in f)if(x!=optional&&x!=optional2&&!d.ContainsKey(x))throw new InvalidDataException("Missing field.");return d;}
