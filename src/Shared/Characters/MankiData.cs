            ...
            AirRMB = new AbilitySpec
            {
                ...
                Stages = new AttackStage[]
                {
                    new() { DurationTicks = 30, ChainWindowTicks = 0,
                            HitboxEvents = new[] { new HitboxEvent { TriggerTick = 16, DurationTicks = 8, Radius = 0.8f, Shape = HitboxShape.Capsule, OffX = 0, OffY = -0.5f, OffZ = 0, EndOffX = 0, EndOffY = -1.5f, EndOffZ = 0, Damage = 10f, BaseKnockback = 20f, KnockbackGrowth = 5f, KnockbackUpward = -12f, StunTicks = 32, Interruptible = true } },
