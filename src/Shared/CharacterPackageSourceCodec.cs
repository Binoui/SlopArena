...
public static class CharacterPackageSourceCodec
{
    ...
    private static TypedCapabilityParameters ParseCapabilityParameters(Dictionary<string, JsonElement> parent, string path, DiagnosticBag d)
    {
        ...
        var allowed = id switch
        {
            ...
            "slop.internal.manki.grapple.v1" => new[] { "fireTriggerTick", "tetherSpeed", "hitboxRadius", "maxFlightTicks", "maxRange", "reelSpeed", "arrivalThreshold", "damage", "stunTicks", "kbAngle", "castDuration" },
            ...
            "slop.internal.manki.overclock.v1" => new[] { "durationTicks" },
            _ => System.Array.Empty<string>(),
        };
        ...
        if (id == "slop.internal.manki.grapple.v1") return new MankiGrappleCapabilityParameters(UShort(p, "fireTriggerTick", path + ".parameters.fireTriggerTick", d), Float(p, "tetherSpeed", path + ".parameters.tetherSpeed", d), Float(p, "hitboxRadius", path + ".parameters.hitboxRadius", d), UShort(p, "maxFlightTicks", path + ".parameters.maxFlightTicks", d), Float(p, "maxRange", path + ".parameters.maxRange", d), Float(p, "reelSpeed", path + ".parameters.reelSpeed", d), Float(p, "arrivalThreshold", path + ".parameters.arrivalThreshold", d), Float(p, "damage", path + ".parameters.damage", d), UShort(p, "stunTicks", path + ".parameters.stunTicks", d), Float(p, "kbAngle", path + ".parameters.kbAngle", d), UShort(p, "castDuration", path + ".parameters.castDuration", d));
        ...
        if (id == "slop.internal.manki.overclock.v1") return new MankiOverclockCapabilityParameters(UShort(p, "durationTicks", path + ".parameters.durationTicks", d));
