...
{
    /// <summary>
    /// Bunny's E — Tornado Kick: forward engage with stun.
    /// Bunny spins forward with a powerful kick. High stun on hit sets up
    /// combo follow-ups. Risky: windup frames with no hitbox before the kick.
    /// Works both grounded and airborne.
    /// </summary>
    public class BunnyTornadoKick : ServerAbility
    {
