...
- Server → Client: `entityId(8) + tick(4) + CharacterStatePacket(65) + hasInput(1) + InputState(19)` = up to 97 bytes per entity (input relay, issue #80; hitstop freeze field, ADR-0012).
